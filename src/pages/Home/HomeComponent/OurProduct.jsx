...
function OurProduct(props) {
    ...
    return (
        <div className={"container mx-auto px-4 lg:px-0 lg:mt-14 mt-8 flex flex-col items-center"}>
            ...
            <div className={"lg:flex justify-between mt-8 space-y-4 lg:space-y-0 lg:flex-wrap px-5 gap-3 items-center"}>
                <ProductCard data={data} loading={loading} error={error} />
            </div>
            <SecondaryButton btnText={"Show More"} classname={"lg:mt-10 mt-8"}/>
        </div>
    );
}
